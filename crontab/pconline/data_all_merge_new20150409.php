...
$fieldMap = array(
	...
	,"products_2in1"=>array("name"=>"name", "price"=>"price", "extra1"=>"pconline_id", "hot"=>"hot", "cover_image"=>"cover_image", "cpu"=>"cpu", "brand_name_en"=>"brand_en", "screen_size"=>"screen_size", "harddisc_size"=>"disk_size", "harddist_type"=>"disk_type", "operating_system"=>"operating_system")
...
$ids = array(
			...
			//, "主板"=>"20811"
			//, "超级本"=>"95585"
			,"products_tablet"=>array(577282,577283,581864,577828,582972,580326,580319,588551,588542,581372)
			//, "手机"=>"20937"
			,"products_2in1"=>array(577289,581438,581720,581505,588538)
			,"products_laptop"=>array(567713,582201,587328,587791,587429,487025,576659,576969)
			//, "SSD"=>"42997"
			//, "台式机"=>"20806"
			,"products_allin1"=>array(575694,575756,580015,570630)
);
