...
<?php include "../sites/sitewide/zh_CN/inc/footer_10x7.inc" ;?>
<script type="text/javascript">
$(document).ready(function(){
	...
	/* ADMaster Event Start */
	$("#mc_container .hot-product.2in1 ul li a").click(function(){
	...
	$("#mc_container .hot-product.tablet ul li a").click(function(){
	...
	$("#mc_container .hot-product.aio ul li a").click(function(){
