...
include_once __DIR__.'/../common/request_processor2.php';
...
function _sendADMasterEvent(currentModule) {
	switch (currentModule) {
  		case "tablet":
    		_smq.push(['custom','Action button-Tablet Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543748,c4564,i0,m202,h"/>');
    		break;
    	case "2in1":
    		_smq.push(['custom','Action button-2in1 Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543750,c4564,i0,m202,h"/>');
    		break;
    	case "desktop":
    		_smq.push(['custom','Action button-Desktop Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543752,c4564,i0,m202,h"/>');
    		break;
    	case "laptop":
    		_smq.push(['custom','Action button-Laptop Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543754,c4564,i0,m202,h"/>');
    		break;
    	case "aio":
    		_smq.push(['custom','Action button-AIO Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543756,c4564,i0,m202,h"/>');
    		break;
    	case "smart-phone":
    		_smq.push(['custom','Action button-Smartphone Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543758,c4564,i0,m202,h"/>');
    		break;
    	case "cpu":
    		_smq.push(['custom','Action button-Processor Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543760,c4564,i0,m202,h"/>');
    		break;
    	case "ssd":
    		_smq.push(['custom','Action button-SSD Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543762,c4564,i0,m202,h"/>');
    		break;
    	case "mainboard":
    		_smq.push(['custom','Action button-Motherboard Collection','Learn More']);
			$("body").append('<img width="1" height="1" border="0" style="position: absolute;top: -1px;" src="http://v.admaster.com.cn/i/a23159,b200543764,c4564,i0,m202,h"/>');
    		break;
  }
}
