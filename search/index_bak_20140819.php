...
// 	,"products_aio"=>array("name", "cpu", "price", "m_brand_en"=>"brand_en")
...
if (empty($keyword)) {
	...
	$urlParam[] = "keyword=".rawurlencode($keyword);
		...
		<div class="hot">
			<div class="item-list">
				<ul>
					...
					<li>
						<div class="image-box">
							<a id="data_index_banner_1" href="http://www.suning.com/emall/cuxiao_10052_10051_6273_.html" target="_blank"><img width="960" src="../common/resource/images/index_hot2.jpg" /></a>
						</div>
					</li>
				</ul>
