...
<div id="mc-container">
	<div class="main">
		<div class="product-filter" style="">
			<div class="ttl">产品筛选</div>
			
			<ul class="tab-wrap">
				<li class="tab fLeft currentTab">价格</li>
				<li class="tab">品牌</li>
			</ul>
			<div class="tab-content">
				<ul class="filter-list-wrap item-list-wrap">
					<li class="itemList" price="">全部</li>
					<li class="itemList" price="%3C3000">3000元以下</li>
					<li class="itemList" price="3000-5999">3000-5999元</li>
					<li class="itemList" price="6000-7999">6000-7999元</li>
					<li class="itemList" price="8000-9999">8000-9999元</li>
					<li class="itemList" price="%3E10000">1万元以上</li>
				</ul>
				<ul class="filter-list-wrap item-list-wrap">
					<li class="itemList" brand="">全部</li>
					<li class="itemList" brand="ASUS">华硕（ASUS）</li>
					<li class="itemList" brand="HP">惠普（HP）</li>
					<li class="itemList" brand="Toshiba">东芝（Toshiba）</li>
					<li class="itemList" brand="Lenovo">联想（Lenovo）</li>
					<li class="itemList" brand="DELL">戴尔（DELL）</li>
					<li class="itemList" brand="Haier">海尔（Haier）</li>
					<li class="itemList" brand="Acer">宏碁（Acer）</li>
					<li class="itemList" brand="联想Thinkpad">联想Thinkpad（Thinkpad）</li>
					<li class="itemList" brand="三星">三星（Samsung）</li>
					<li class="itemList" brand="微软">微软（Microsoft）</li>
				</ul>
			</div>
...
$(document).ready(function(){
	$(".itemList").click(function(){
		var url = "index.php?";
		if ($(this).attr("brand") != undefined) {
			url += "brand="+$(this).attr("brand");
		}
		if ($(this).attr("price") != undefined) {
			url += "price="+$(this).attr("price");
		}
