...
<script>
  ...
  ga('create', 'UA-41064651-13', 'intel.com');
  ga('send', 'pageview');
...
<div id="mc-container">
	<div class="main">
		...
		<ul class="tab-wrap fixed-tab-wrap">				
			<li class="tab fLeft <?=$type=='hot' ? 'currentTab' : '';?>"><a onclick="ga('send', 'event', 'menu', 'click', 'hot');tracking('ProductListSortHot');" href="index.php?t=hot&r=desc">热品</a><i class="iconBox orderIcon"></i></li>
			<li class="tab fLeft <?=$type=='new' ? 'currentTab' : '';?>"><a onclick="ga('send', 'event', 'menu', 'click', 'new');tracking('ProductListSortNew');" href="index.php?t=new&r=desc">新品</a><i class="iconBox orderIcon"></i></li>
			<li class="tab fLeft <?=$type=='price' ? 'currentTab' : '';?>"><a onclick="ga('send', 'event', 'menu', 'click', 'price');tracking('ProductListSortPrice');" href="index.php?t=price&r=<?=$type=='price'&&$order == 'asc' ? 'desc' : 'asc'; ?>">价格</a><i class="iconBox orderIcon"></i></li>
			<li class="tab"><a onClick="ga('send', 'event', 'menu', 'click', 'filter');" href="filter.php">筛选</a></li>
		</ul>
		<ul class="item-list-wrap productListWrap">
			<?php foreach ($products as $p) { ?>
			<li class="itemList proList" onclick="showDetail('<?=$p['purchase_link']?>',8);ga('send', 'event', 'product', 'click', '<?=$p['name']; ?>');">
		...
		<p class="loadBtn" nextpage="2" onClick="ga('send', 'event', 'load', 'click', 'load');"><span class="itemNumContainer"><?=count($products)?>/<?=$total?></span>点击加载更多产品</p>
