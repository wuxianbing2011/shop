...
$pids = !empty($_GET['product']) ? $_GET['product'] : '';
if ($pids == '') {
...
if (empty($pids)) {
	...
	$urlParam[] = "product=".$pids;
	$where .= " and pconline_id in ({$pids})";
	$pageUrl .= "&product=".$pids;
...
<?php } ?>
		<div class="product-box">
			...
			<div class="header">
				<span class="count"><a id="data_wishing_breadcrumb_1" href="../">首页</a> > <span style="color:#006fc8;">心愿单</span></span>
				<?php 
					$orderUrl = "index.php";
			...
			<div style="padding: 20px 0px;">
				<img src="../common/resource/images/wishing_title.jpg" />
			</div>
			...
			<ul class="product-list">
				...
				<li class="product_<?=$p['pconline_id'];?>">
					...
					<div class="infobox">
						...
						?>
						<p><a id="data_wishing_product_<?=$p['pconline_id'];?>" href="../<?=$pType."/detail.php?id=".$p['pconline_id'];?>" target="_blank" class="btn-detail">了解详情</a></p>
					</div>
					<div class="logo">
						...
						<p class="add-cmp"><input id="data_wishing_product_<?=$p['pconline_id'];?>_addcomparison" product="<?=$p['pconline_id'];?>" module="<?=$tableToModuleMap[$p['type']]; ?>" type="checkbox" /> 加入对比</p>
						<div class="clear"></div>
					</div>
					<?php if ($p['hot']) { ?>
					...
					<div class="cover">
						...
						<div class="options">
							<p id="data_wishing_product_<?=$p['pconline_id'];?>_addwishing" class="wishing" product="<?=$p['pconline_id'];?>"><img src="../common/resource/images/btn_add_wishing.png" /></p>
							<p class="share"><img src="../common/resource/images/btn_share_product.png" /></p>
							<ul>
								<li class="top_line"></li>
								<li class="share_item sina"><a id="data_wishing_product_<?=$p['pconline_id'];?>_share_weibo" href="javascript: void 0;">新浪微博</a></li>
								<li class="share_item sohu"><a id="data_wishing_product_<?=$p['pconline_id'];?>_share_sohu" href="javascript: void 0;">搜狐微博</a></li>
								<li class="share_item qzone"><a id="data_wishing_product_<?=$p['pconline_id'];?>_share_qq" href="javascript: void 0;">QQ空间</a></li>
								<li class="share_item kaixin"><a id="data_wishing_product_<?=$p['pconline_id'];?>_share_kaixin" href="javascript: void 0;">开心网</a></li>
								<li class="share_item renren"><a id="data_wishing_product_<?=$p['pconline_id'];?>_share_renren" href="javascript: void 0;">人人网</a></li>
							</ul>
						</div>
					</div>
				</li>
			...
			<div style="text-align:center; clear:both; padding-top:30px;">
				<a id="data_wishing_new_wishing" href="../index.php"><img src="../common/resource/images/make_own_wishing.jpg" /></a>
			</div>
		</div>
<?php if (!$inAjax) { ?>
</div>
...
<?php include_once __DIR__.'/../../sites/sitewide/HAT/50recode/zh_CN/ltr_Quirks_W1024_HTTP_UTF8/gf_default.inc'; ?>
